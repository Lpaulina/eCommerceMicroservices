...
public class SecurityConfig {
    ...
    public SecurityConfig(CommerceProperties commerceProperties) {
    ...
    private List<GrantedAuthority> extractRolesFromResourceAccess(Jwt jwt) {
        ...
        Map<String, Object> client = (Map<String, Object>) resourceAccess.get(commerceProperties.getClientName());
    ...
    private Stream<GrantedAuthority> extractRolesFromClaimsResource(Map<String, Object> claims) {
        ...
        Map<String, Object> resource = (Map<String, Object>) resourceAccess.get(commerceProperties.getClientName());
